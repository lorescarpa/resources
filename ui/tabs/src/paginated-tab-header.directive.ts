...
export type BriPaginatedTabHeaderItem = FocusableOption & {
 ...
 */
@Directive()
export abstract class BriPaginatedTabHeaderDirective
  implements AfterContentChecked, AfterContentInit, AfterViewInit, OnDestroy
{
  abstract _items: QueryList<BriPaginatedTabHeaderItem>;
  abstract _inkBar: {
    hide: () => void;
  ...
  private _keyManager!: FocusKeyManager<BriPaginatedTabHeaderItem>;
  ...
  ngAfterContentInit() {
    ...
    this._keyManager = new FocusKeyManager<BriPaginatedTabHeaderItem>(
      this._items
    )
  ...
  private _itemsResized(): Observable<ResizeObserverEntry[]> {
    ...
    return this._items.changes.pipe(
      ...
      switchMap(
        (tabItems: QueryList<BriPaginatedTabHeaderItem>) =>
