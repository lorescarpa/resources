 ...
 */
@Component({
  selector: 'bri-month-view',
  templateUrl: './month-view.component.html',
  exportAs: 'briMonthView',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: true,
  imports: [BriCalendarBodyComponent],
})
export class BriMonthViewComponent<D>
  implements AfterContentInit, OnChanges, OnDestroy
{
  ...
  @Input() activeDrag: BriCalendarUserEvent<D> | null = null;
  ...
  @Output() readonly dragEnded = new EventEmitter<
    BriCalendarUserEvent<DateRange<D> | null>
  >();
  ...
  @ViewChild(BriCalendarBodyComponent)
  _matCalendarBody!: BriCalendarBodyComponent;

  /** The label for this month (e.g. "January 2017"). */
  _monthLabel!: string;

  /** Grid of calendar cells representing the dates of the month. */
  _weeks!: BriCalendarCell[][];
  ...
  constructor(
    ...
    @Optional()
    private _rangeStrategy?: BriDateRangeSelectionStrategy<D>
  ) {
    if (isDevMode()) {
  ...
  _dateSelected(event: BriCalendarUserEvent<number>) {
   ...
   */
  _updateActiveDate(event: BriCalendarUserEvent<number>) {
  ...
  _previewChanged({
    event,
    value: cell,
  }: BriCalendarUserEvent<BriCalendarCell<D> | null>) {
   ...
   */
  protected _dragEnded(event: BriCalendarUserEvent<D | null>) {
  ...
  /** Creates BriCalendarCells for the dates in this month. */
  private _createWeekCells() {
    ...
    for (
      ...
      this._weeks[this._weeks.length - 1].push(
        new BriCalendarCell<D>(
          i + 1,
          dateNames[i].padStart(2, '0'),
          ariaLabel,
          enabled,
          cellClasses,
